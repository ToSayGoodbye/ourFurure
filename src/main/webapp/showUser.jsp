...
<head lang="en">
	...
	%>
<body onload="query(0,'','')" style="background:#000;color:#76772E">
   <nav class="navbar navbar-inverse">
	...
	<div class="container-fluid" style="background: #000">
            <div class="row">
                <div class="col-sm-2" style="background: #000">
                ...
                <div class="col-sm-10">
                    <div class="panel panel-default" style="background: #000">
                        <div class="panel-heading" style="background:#000;color:rgb(118, 119, 46)">
                      		      搜索
                        </div>
